...
class Sas_Shop_Settings {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sas_Shop_Callback_Helper    $callback    Render HTML elements.
	 */
	protected $callback;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Sas_Shop_Sanitization_Helper    $sanitization    Sanitize and validate settings.
	 */
	 ...
	 * @param 	Sas_Shop_Callback_Helper 		$settings_callback 		The callback helper for rendering HTML markups
	 * @param 	Sas_Shop_Sanitization_Helper 	$settings_sanitization 	The sanitization helper for sanitizing settings
	 */
	...
	*/
	public function register_settings() {
		...
		if ( false == get_option( 'sas_shop_settings' ) ) {
			add_option( 'sas_shop_settings', array(), '', 'yes' );
		}
		...
		register_setting( 'sas_shop_settings', 'sas_shop_settings', array( $this->sanitization, 'settings_sanitize' ) );
