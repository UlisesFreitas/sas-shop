<?php
	...
	$cart_products = isset($_SESSION['cart_products']) ? $_SESSION['cart_products'] : array();
	$subtotal = isset($_SESSION['cart_subtotal']) ? $_SESSION['cart_subtotal'] : 0;
	$cart_taxes = isset($_SESSION['cart_taxes']) ? $_SESSION['cart_taxes'] : 0;
	$shipping_checked = isset($_SESSION['shipping_checked']) ? $_SESSION['shipping_checked'] : 0;
	$total_cart_qty = isset($_SESSION['total_cart_qty']) ? $_SESSION['total_cart_qty'] : 0;
...
<h3><?php echo __( 'Billing information', 'sas-shop'); ?></h3>
	...
	<form id="place-order-form" action="<?php echo get_the_permalink( get_option( 'sas_shop_sas-shop-signup_page_id' ) ); ?>" method="post">
		...
		<p class="form-row">
			<input type="text" name="email" id="email" placeholder="<?php _e( '* Email', 'sas-shop' ); ?>" value="<?php echo $email; ?>">
		</p>
		...
		<div class="sas-shop-payments" id="sas_shop_bank_transfer">
			<input type="radio" name="sas_shop_payment_method[]" value="bank_transfer" id="sas_shop_bank_transfer_selected">
		...
		<div class="sas-shop-payments">
			<input type="radio" name="sas_shop_payment_method[]" value="cash_on_delivery" id="sas_shop_cod_selected">
...
<div class="sas-shop-col-12">
		<p class="signup-submit sas-shop-to-right">
